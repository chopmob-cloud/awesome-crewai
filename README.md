...
|          [AlgoVoi CrewAI Adapter](https://github.com/chopmob-cloud/AlgoVoi-Platform-Adapters/tree/master/ai-agent-frameworks/crewai)          |   Payment-gate any CrewAI agent or crew using x402, MPP, or AP2 — paid in USDC on Algorand, VOI, Hedera, Stellar, Base, Solana, or Tempo. Drop-in `AlgoVoiPaymentTool` compatible with CrewAI's native `BaseTool` interface. 68/68 tests.   | [@chopmob-cloud](https://github.com/chopmob-cloud)         |
